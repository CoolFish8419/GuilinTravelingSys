 ...
 <div class="content1">
  <div class="head_content">
    <div class="left_content">
      <div class="title">
        桂林市，简称“桂”，古称桂州、静江、始安，广西壮族自治区辖地级市，省域副中心城市，地处中国华南，湘桂走廊南端，位于南岭山系西南部、桂林—阳朔岩溶盆地北端中部，处在“湘桂夹道”中，“桂林”之名，始于秦代，秦始皇置桂林、象、南海三郡，桂林郡因当地盛产玉桂而成名，这是“桂林”名称的最早起源。
      </div>
    ...
    <div class="right_content">
      ...
      indicator-type="dot"
      >
       <a-carousel-item v-for="image in images" :key="image.id" :style="{width:'100%'}">
        <img
          :src="image.src"
          :style="{
            width: '100%',
