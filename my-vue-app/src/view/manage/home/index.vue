   ...
   <div class="top_left">
    ...
    <div class="top_right">
      ...
      <div style="width: 100px; height: 150px;background-color: salmon;">
       <div class="title">景点数</div><el-image style="width: 60px; height: 90px" src="https://s3.bmp.ovh/imgs/2023/06/18/36b1b98a3b3ff2ee.png" fit="contain" /></div>
      ...
      <div style="width: 100px; height: 150px;background-color:rgba(0,122,204);">
       ...
       <el-image style="width: 60px; height: 90px" src="https://s3.bmp.ovh/imgs/2023/06/18/17fbec95929d1726.png" fit="contain" />
      </div>
      ...
      <div style="width: 100px; height: 150px;background-color:rgba(250,195,38);">
       ...
       <el-image style="width: 60px; height: 90px" src="https://s3.bmp.ovh/imgs/2023/06/18/eb6a1b4a7fae8430.png" fit="contain" />
      </div>
      ...
      <div style="width: 100px; height: 150px;background-color:rgba(41,184,183)">
       ...
       <el-image style="width: 60px; height: 90px" src="https://s3.bmp.ovh/imgs/2023/06/18/9fd119bdb058e098.png" fit="contain" />
      </div>
